...
public class AbcActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            //saca los numeros
            JSONArray wordsArr = obj.getJSONArray("abc");
            ...
            for(int i = 0; i < wordsArr.length(); i++)
            {
                ...
                if((i+1) % 2 == 0)
                    words.add(new Word(word.getString("spanish"), word.getString("german"), picResource, audioResource));
                else
                    words.add(new Word(word.getString("spanish"), word.getString("german"), picResource, audioResource, true));
        ...
        WordAdapter adapter = new WordAdapter(this, words, true);
